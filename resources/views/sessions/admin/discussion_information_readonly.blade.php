                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="row mb-5 mt-3">
                            <div class="col">
                                <input type="hidden" name="id" value="{{$discussion->id}}" disabled>
                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 g-3">
                                    <div class="col">
                                        <label for="topic">Topic:</label>
                                        <input type="text" name="topic" class="form-control mb-2" value="{{$discussion->topic}}" id="topic" disabled>
                                    </div>
                                    <div class="col">
                                        <label for="information">Information:</label>
                                        <textarea class="form-control" name="information" id="information" cols="30" rows="10" disabled>{{$discussion->information}}</textarea>
                                    </div>
                                </div>
                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 g-3">
                                    <div class="col">
                                        <label for="related_class_1">Related Class</label>
                                        <select name="related_class_1" id="related_class_1" class="form-select" aria-label="select-related_class_1" disabled>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="related_module" id="related_module" class="form-select" aria-label="select-related_module" disabled>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="month" id="month" class="form-select" aria-label="select-month" disabled>
