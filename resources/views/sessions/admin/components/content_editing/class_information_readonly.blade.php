                ...
                <form action="#" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col">
                            ...
                            <input type="text" name="class_name" id="class_name" class="form-control" value="{{$class->name}}" disabled>
                        </div>
                        <div class="col">
                    ...
                    <input type="text" name="class_excerpt" id="classExcerpt" class="form-control" value="{{$class->excerpt}}" disabled>

                    <label for="classDescription">Description:</label>
                    <textarea name="class_description" id="classDescription" cols="20" rows="5" class="form-control" disabled>{{$class->description}}</textarea>
                    <div class="row g-3">
                        <div class="col">
