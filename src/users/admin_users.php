      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9  PageContent ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2 text-light">Business Administrativa - Administrative Users</h1>
          </div>
          <div class="container">
          <div class="row">
          <div class="col">
          <?php
          $sql = "SELECT students.student_id, students.first_name, students.last_name, students.email, students.account_status, accounts.admin FROM students JOIN accounts ON students.student_id=accounts.student_id WHERE admin = 1;";
        ...
        <label for="acc_new_status">What is the new admin status?<br />
        <ul>
        <li>Yes = 1</li>
        <li>No = 0</li>
        </ul>
        </label><br />
        <select class="form-control" name="admin_status" id="acc_new_status">
