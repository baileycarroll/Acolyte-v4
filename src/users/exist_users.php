      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9  PageContent ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2 text-light">Business Administrativa - Exisiting Users</h1>
          ...
          <div class="col">
          <?php
          $sql = "SELECT * FROM students WHERE account_status = 'Active'";
        ...
        <form action="includes/exist_update.inc.php" method="post">
