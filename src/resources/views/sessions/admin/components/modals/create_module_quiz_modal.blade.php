<div class="modal fade" id="createModuleQuizModal" tabindex="-1" aria-labelledby="createModuleQuizModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <form action="/create_module_quiz" method="post">
                @csrf
