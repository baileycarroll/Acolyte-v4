        ...
        <div class="modal-content">
            <form action="/add_license" method="post">
                ...
                <div class="modal-body">
                    ...
                    <label for="#license_days">Days Allowed</label>
                    <input type="number" name="license_days" id="license_days" class="form-control" required>
                    ...
                    <label for="#license_available">License(s) Available:</label>
                    <input type="number" name="license_available" id="license_available" class="form-control mb-2" requried>
